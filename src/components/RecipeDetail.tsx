...
export default function RecipeDetail({ recipe, onClose, onDelete }: RecipeDetailProps) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      ...
      >
        <div className="p-6">
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex gap-2">
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={onDelete}
                className="text-red-500 hover:text-red-600 dark:text-red-400 dark:hover:text-red-300 p-2 rounded-full hover:bg-red-50 dark:hover:bg-red-900/20"
              >
                <svg
          ...
          <motion.div
            ...
            className="grid grid-cols-2 gap-4 mb-6 text-sm bg-gray-50 dark:bg-gray-700 p-4 rounded-lg"
          >
